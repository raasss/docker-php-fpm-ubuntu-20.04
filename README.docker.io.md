...
-	[`0.1.7`, `latest`](https://github.com/raasss/docker-php-fpm-ubuntu-20.04/blob/0.1.7/Dockerfile)
-	[`7.4.3-4ubuntu2.8-0.0.7`, `7.4.3-4ubuntu2.8`](https://github.com/raasss/docker-php-fpm-ubuntu-20.04/blob/7.4.3-4ubuntu2.8/Dockerfile)
-	[`7.4.3-4ubuntu1-0.0.15`, `7.4.3-4ubuntu1`](https://github.com/raasss/docker-php-fpm-ubuntu-20.04/blob/7.4.3-4ubuntu1-0.0.15/Dockerfile)
-	[`7.4.3-4ubuntu2.7-0.0.7`, `7.4.3-4ubuntu2.7`](https://github.com/raasss/docker-php-fpm-ubuntu-20.04/blob/7.4.3-4ubuntu2.7-0.0.7/Dockerfile)

# Quick reference (cont.)

-	**Where to file issues**:  
	Issues can be filed on [GitHub Issues](https://github.com/raasss/docker-php-fpm-ubuntu-20.04/issues) under specific branch named by specific package version.

-	**Supported architectures**:
    `linux/amd64`, `linux/arm/v7`, `linux/arm64` 

-	**Source of this description**:  
	[README.docker.io.md]([here](https://github.com/raasss/docker-php-fpm-ubuntu-20.04/blob/main/README.docker.io.md))
